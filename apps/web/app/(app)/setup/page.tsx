        ...
        <div className="flex flex-1 p-10 gap-10">
          <div className="flex-1 flex flex-col space-y-8">
            <div className="space-y-4">
              <label className="text-xl font-arcade text-[#cc9933] uppercase tracking-tighter block">
                TARGET PROTOCOL
              </label>
              ...
              <div className="flex flex-wrap gap-2">
                <span className="font-arcade text-[8px] text-slate-500 mr-2 uppercase self-center">
                  Hot:
                </span>
          ...
          <div className="w-[42%] flex flex-col space-y-6">
            <div className="bg-[#1a1a25] border-2 border-[#3366ff] p-5">
              ...
              <p className="text-[12px] text-slate-400 italic font-sans leading-snug">
                {MBTI_MAP[userMBTI].style}
              </p>
            </div>

            <div className="flex-1 flex flex-col">
              <label className="text-lg font-arcade text-[#cc9933] mb-4 uppercase block">
                AUDIT_DIMENSIONS
              </label>
